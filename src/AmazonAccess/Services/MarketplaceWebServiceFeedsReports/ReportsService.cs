...
namespace AmazonAccess.Services.MarketplaceWebServiceFeedsReports
{
	...
	{
		public void GetInventoryReport( IMarketplaceWebServiceFeedsReports client )
		{
		...
		private string GetReportId( IMarketplaceWebServiceFeedsReports client, GetReportListRequest request )
		{
		...
		private string GetReportIdInNextPages( GetReportListByNextTokenResult reportListByNextTokenResult, IMarketplaceWebServiceFeedsReports client, string reportRequestId, string reportId )
		{
		...
		private string GetGeneratedReportId( IMarketplaceWebServiceFeedsReports client, string reportRequestId )
		{
		...
		private string GetGeneratedReportIdFromNextPages( GetReportRequestListByNextTokenResult reportRequestListByNextTokenResult, IMarketplaceWebServiceFeedsReports client, string reportRequestId, string reportId )
		{
			if( !string.IsNullOrEmpty( reportId ) )
				return reportId;
		...
		private string GetReportRequestId( IMarketplaceWebServiceFeedsReports client, RequestReportRequest request )
		{
			var reportId = string.Empty;
