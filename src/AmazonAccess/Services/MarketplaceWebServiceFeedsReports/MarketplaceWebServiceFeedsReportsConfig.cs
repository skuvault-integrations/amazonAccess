...
namespace AmazonAccess.Services.MarketplaceWebServiceFeedsReports
{
    ...
    /// </summary>
    public class MarketplaceWebServiceFeedsReportsConfig
    {
        ...
        public MarketplaceWebServiceFeedsReportsConfig WithSignatureMethod(String signatureMethod)
        {
        ...
        /// <returns>this instance</returns>
        public MarketplaceWebServiceFeedsReportsConfig WithSignatureVersion(String signatureVersion)
        {
        ...
        /// <returns>this instance</returns>
        public MarketplaceWebServiceFeedsReportsConfig WithUserAgent(String userAgent)
        {
        ...
        /// <returns>this instance</returns>
        public MarketplaceWebServiceFeedsReportsConfig WithServiceURL(String serviceURL)
        {
        ...
        /// <returns>this instance</returns>
        public MarketplaceWebServiceFeedsReportsConfig WithProxyHost(String proxyHost)
        {
        ...
        /// <returns>this instance</returns>
        public MarketplaceWebServiceFeedsReportsConfig WithProxyPort(int proxyPort)
        {
        ...
        /// <returns>this instance</returns>
        public MarketplaceWebServiceFeedsReportsConfig WithMaxErrorRetry(int maxErrorRetry)
        {
