...
namespace AmazonAccess.Services.MarketplaceWebServiceFeedsReports
{
	...
	{
		public void SubmitFeed( IMarketplaceWebServiceFeedsReports client, SubmitFeedRequest request )
		{
		...
		private bool IsReportReady( IMarketplaceWebServiceFeedsReports client, string feedSubmissionId, string merchant, string mwsAuthToken )
		{
			var ready = false;
