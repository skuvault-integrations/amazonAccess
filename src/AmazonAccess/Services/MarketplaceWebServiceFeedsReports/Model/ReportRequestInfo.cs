...
namespace AmazonAccess.Services.MarketplaceWebServiceFeedsReports.Model
{
    ...
    public class ReportRequestInfo
    {
        ...
        protected internal String ToXMLFragment() {
            ...
            if (this.IsSetReportRequestId()) {
                xml.Append("<ReportRequestId>");
                xml.Append(this.EscapeXML(this.ReportRequestId));
                xml.Append("</ReportRequestId>");
            }
            if (this.IsSetReportType()) {
                xml.Append("<ReportType>");
                xml.Append(this.EscapeXML(this.ReportType));
                xml.Append("</ReportType>");
            }
            ...
            if (this.IsSetReportProcessingStatus()) {
                xml.Append("<ReportProcessingStatus>");
                xml.Append(this.EscapeXML(this.ReportProcessingStatus));
                xml.Append("</ReportProcessingStatus>");
            }
            if (this.IsSetGeneratedReportId()) {
                xml.Append("<GeneratedReportId>");
                xml.Append(this.EscapeXML(this.GeneratedReportId));
                xml.Append("</GeneratedReportId>");
            }
