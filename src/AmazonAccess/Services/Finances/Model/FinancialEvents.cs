...
namespace AmazonAccess.Services.Finances.Model
{
	public class FinancialEvents : AbstractMwsObject
	{
		...
		public List< ShipmentEvent > GuaranteeClaimEventList
		{
			...
			set 
			{ 
				this._guaranteeClaimEventList = value; 
			}
		}
		...
		public List< ShipmentEvent > ChargebackEventList
		{
			...
			set 
			{ 
				this._chargebackEventList = value; 
			}
		}
		...
		public List< PayWithAmazonEvent > PayWithAmazonEventList
		{
			...
			set
			{ 
				this._payWithAmazonEventList = value; 
			}
		}
		...
		public List< SolutionProviderCreditEvent > ServiceProviderCreditEventList
		{
			...
			set 
			{ 
				this._serviceProviderCreditEventList = value; 
			}
		}
		...
		public List< RetrochargeEvent > RetrochargeEventList
		{
			...
			set 
			{ 
				this._retrochargeEventList = value; 
			}
		}
		...
		public List< RentalTransactionEvent > RentalTransactionEventList
		{
			...
			set 
			{ 
				this._rentalTransactionEventList = value; 
			}
		}
		...
		public List< PerformanceBondRefundEvent > PerformanceBondRefundEventList
		{
			...
			set
			{ 
				this._performanceBondRefundEventList = value; 
			}
		}
		...
		public List< ProductAdsPaymentEvent > ProductAdsPaymentEventList
		{
			...
			set
			{ 
				this._productAdsPaymentEventList = value; 
			}
		}
		...
		public List< ServiceFeeEvent > ServiceFeeEventList
		{
			...
			set 
			{ 
				this._serviceFeeEventList = value; 
			}
		}
		...
		public List< SellerDealPaymentEvent > SellerDealPaymentEventList
		{
			...
			set 
			{ 
				this._sellerDealPaymentEventList = value; 
			}
		}
		...
		public List< DebtRecoveryEvent > DebtRecoveryEventList
		{
			...
			set 
			{ 
				this._debtRecoveryEventList = value; 
			}
		}
		...
		public List< LoanServicingEvent > LoanServicingEventList
		{
			...
			set 
			{ 
				this._loanServicingEventList = value; 
			}
		}
		...
		public List< AdjustmentEvent > AdjustmentEventList
		{
			...
			set 
			{ 
				this._adjustmentEventList = value; 
			}
		}
		...
		public List< SAFETReimbursementEvent > SAFETReimbursementEventList
		{
			...
			set
			{ 
				this._safetReimbursementEventList = value; 
			}
		}
		...
		public List< SellerReviewEnrollmentPaymentEvent > SellerReviewEnrollmentPaymentEventList
		{
			...
			set
			{ 
				this._sellerReviewEnrollmentPaymentEventList = value; 
			}
		}
		...
		public List< FBALiquidationEvent > FBALiquidationEventList
		{
			...
			set 
			{ 
				this._fbaLiquidationEventList = value; 
			}
		}
		...
		public List< CouponPaymentEvent > CouponPaymentEventList
		{
			...
			set 
			{ 
				this._couponPaymentEventList = value; 
			}
		}
		...
		public List< ImagingServicesFeeEvent > ImagingServicesFeeEventList
		{
			...
			set 
			{ 
				this._imagingServicesFeeEventList = value; 
			}
		}
		...
		public List< NetworkComminglingTransactionEvent > NetworkComminglingTransactionEventList
		{
			...
			set 
			{ 
				this._networkComminglingTransactionEventList = value; 
			}
		}
		...
		public List< AffordabilityExpenseEvent > AffordabilityExpenseEventList
		{
			...
			set 
			{ 
				this._affordabilityExpenseEventList = value; 
			}
		}
		...
		public List< AffordabilityExpenseEvent > AffordabilityExpenseReversalEventList
		{
			...
			set 
			{ 
				this._affordabilityExpenseReversalEventList = value; 
			}
		}
