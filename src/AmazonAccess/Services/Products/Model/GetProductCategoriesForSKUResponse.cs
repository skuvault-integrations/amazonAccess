...
namespace AmazonAccess.Services.Products.Model
{
	...
	public class GetProductCategoriesForSKUResponse: AbstractMwsObject, IMwsResponse
	{
		...
		public GetProductCategoriesForSKUResult GetProductCategoriesForSKUResult{ get; set; }
		...
		/// <returns>this instance.</returns>
		public GetProductCategoriesForSKUResponse WithResponseHeaderMetadata( MwsResponseHeaderMetadata responseHeaderMetadata )
		{
		...
		{
			this.GetProductCategoriesForSKUResult = reader.Read< GetProductCategoriesForSKUResult >( "GetProductCategoriesForSKUResult" );
			this.ResponseMetadata = reader.Read< ResponseMetadata >( "ResponseMetadata" );
		}

		public override void WriteFragmentTo( IMwsWriter writer )
		{
			writer.Write( "GetProductCategoriesForSKUResult", this.GetProductCategoriesForSKUResult );
