...
namespace AmazonAccess.Services.Products.Model
{
	...
	public class GetLowestPricedOffersForASINResponse: AbstractMwsObject, IMwsResponse
	{
		...
		{
			return this.GetLowestPricedOffersForASINResult != null;
		}
		...
		/// <returns>this instance.</returns>
		public GetLowestPricedOffersForASINResponse WithResponseHeaderMetadata( MwsResponseHeaderMetadata responseHeaderMetadata )
		{
		...
		{
			this.GetLowestPricedOffersForASINResult = reader.Read< GetLowestPricedOffersForASINResult >( "GetLowestPricedOffersForASINResult" );
			this.ResponseMetadata = reader.Read< ResponseMetadata >( "ResponseMetadata" );
		}

		public override void WriteFragmentTo( IMwsWriter writer )
		{
			writer.Write( "GetLowestPricedOffersForASINResult", this.GetLowestPricedOffersForASINResult );
