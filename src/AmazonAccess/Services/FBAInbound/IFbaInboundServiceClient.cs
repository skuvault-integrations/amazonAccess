...
namespace AmazonAccess.Services.FBAInbound
{
	...
	/// 
	/// </summary>
	public interface IFbaInboundServiceClient
	{
		/// <summary>
		/// Confirm Preorder
		/// </summary>
		...
		/// if the NBD is met.
		/// </remarks>
		ConfirmPreorderResponse ConfirmPreorder( ConfirmPreorderRequest request, string marker );
		...
		/// </remarks>
		ConfirmTransportRequestResponse ConfirmTransportRequest( ConfirmTransportInputRequest request, string marker );
		...
		/// </remarks>
		CreateInboundShipmentResponse CreateInboundShipment( CreateInboundShipmentRequest request, string marker );
		...
		/// </remarks>
		CreateInboundShipmentPlanResponse CreateInboundShipmentPlan( CreateInboundShipmentPlanRequest request, string marker );
		...
		/// </remarks>
		EstimateTransportRequestResponse EstimateTransportRequest( EstimateTransportInputRequest request, string marker );
		...
		/// </remarks>
		GetBillOfLadingResponse GetBillOfLading( GetBillOfLadingRequest request, string marker );
		...
		///// </remarks>
		//GetInboundGuidanceForASINResponse GetInboundGuidanceForASIN( GetInboundGuidanceForASINRequest request, string marker );
		...
		/// </remarks>
		GetInboundGuidanceForSKUResponse GetInboundGuidanceForSKU( GetInboundGuidanceForSKURequest request, string marker );
		...
		/// </remarks>
		GetPackageLabelsResponse GetPackageLabels( GetPackageLabelsRequest request, string marker );
		...
		/// </remarks>
		GetPalletLabelsResponse GetPalletLabels( GetPalletLabelsRequest request, string marker );
		...
		/// pre-orderable.
		/// </remarks>
		GetPreorderInfoResponse GetPreorderInfo( GetPreorderInfoRequest request, string marker );
		...
		/// </remarks>
		GetPrepInstructionsForASINResponse GetPrepInstructionsForASIN( GetPrepInstructionsForASINRequest request, string marker );
		...
		/// of additional required prep that must be performed.
		/// </remarks>
		GetPrepInstructionsForSKUResponse GetPrepInstructionsForSKU( GetPrepInstructionsForSKURequest request, string marker );
		...
		/// </remarks>
		GetTransportContentResponse GetTransportContent( GetTransportContentRequest request, string marker );
		...
		///       * JP/CN: PackageLabel_Plain_Paper
		/// </remarks>
		GetUniquePackageLabelsResponse GetUniquePackageLabels( GetUniquePackageLabelsRequest request, string marker );
		...
		/// </remarks>
		ListInboundShipmentItemsResponse ListInboundShipmentItems( ListInboundShipmentItemsRequest request, string marker );
		...
		/// </remarks>
		ListInboundShipmentItemsByNextTokenResponse ListInboundShipmentItemsByNextToken( ListInboundShipmentItemsByNextTokenRequest request, string marker );
		...
		/// </remarks>
		ListInboundShipmentsResponse ListInboundShipments( ListInboundShipmentsRequest request, string marker );
		...
		/// shipments. If a NextToken is not returned, it indicates the end-of-data.
		/// </remarks>
		ListInboundShipmentsByNextTokenResponse ListInboundShipmentsByNextToken( ListInboundShipmentsByNextTokenRequest request, string marker );
		...
		/// </remarks>
		PutTransportContentResponse PutTransportContent( PutTransportContentRequest request, string marker );
		...
		/// otherwise an explicit error will be returned.
		/// </remarks>
		UpdateInboundShipmentResponse UpdateInboundShipment( UpdateInboundShipmentRequest request, string marker );
		...
		/// </remarks>
		VoidTransportRequestResponse VoidTransportRequest( VoidTransportInputRequest request, string marker );
	}
}
