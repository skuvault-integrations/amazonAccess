...
namespace AmazonAccess.Services.FbaInventory
{
	...
	public class FbaInventoryServiceClient: IFbaInventoryService
	{
		...
		{
			return this.connection.Call(
				new Request< ListInventorySupplyResponse >( "ListInventorySupply", typeof( ListInventorySupplyResponse ), this.servicePath ),
				request );
		}
		...
		{
			return this.connection.Call(
				new Request< ListInventorySupplyByNextTokenResponse >( "ListInventorySupplyByNextToken", typeof( ListInventorySupplyByNextTokenResponse ), this.servicePath ),
				request );
		}
