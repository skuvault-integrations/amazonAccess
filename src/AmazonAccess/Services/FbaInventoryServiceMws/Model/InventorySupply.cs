...
namespace AmazonAccess.Services.FbaInventoryServiceMws.Model
{
    ...
    public class InventorySupply : AbstractMwsObject
    {
        ...
        public override void WriteFragmentTo(IMwsWriter writer)
        {
            ...
            writer.Write("FNSKU", this._fnsku);
            writer.Write("ASIN", this._asin);
            writer.Write("Condition", this._condition);
            writer.Write("TotalSupplyQuantity", this._totalSupplyQuantity);
            writer.Write("InStockSupplyQuantity", this._inStockSupplyQuantity);
            writer.Write("EarliestAvailability", this._earliestAvailability);
            writer.Write("SupplyDetail", this._supplyDetail);
        }
