...
namespace AmazonAccess.Services.FeedsReports.Model
{
	...
	public class GetReportScheduleListRequest: AbstractMwsObject
	{
		...
		public GetReportScheduleListRequest WithMarketplaceId( string[] marketplaceId )
		{
		...
		/// <returns>this instance</returns>
		public GetReportScheduleListRequest WithSellerId( String sellerId )
		{
