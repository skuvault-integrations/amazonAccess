...
namespace AmazonAccess.Services.FeedsReports.Model
{
	...
	public class GetReportRequestListByNextTokenRequest: AbstractMwsObject
	{
		...
		public GetReportRequestListByNextTokenRequest WithMarketplaceId( string[] marketplaceId )
		{
		...
		/// <returns>this instance</returns>
		public GetReportRequestListByNextTokenRequest WithSellerId( String sellerId )
		{
