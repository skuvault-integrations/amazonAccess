...
namespace AmazonAccess.Services.FeedsReports.Model
{
	...
	public class GetReportScheduleListByNextTokenRequest: AbstractMwsObject
	{
		...
		public GetReportScheduleListByNextTokenRequest WithMarketplaceId( string[] marketplaceId )
		{
		...
		/// <returns>this instance</returns>
		public GetReportScheduleListByNextTokenRequest WithSellerId( String sellerId )
		{
