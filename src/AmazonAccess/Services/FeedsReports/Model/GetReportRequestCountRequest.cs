...
namespace AmazonAccess.Services.FeedsReports.Model
{
	...
	public class GetReportRequestCountRequest: AbstractMwsObject
	{
		...
		public GetReportRequestCountRequest WithMarketplaceId( string[] marketplaceId )
		{
		...
		/// <returns>this instance</returns>
		public GetReportRequestCountRequest WithSellerId( String sellerId )
		{
