...
namespace AmazonAccess.Services.FeedsReports
{
	...
	public interface IFeedReportServiceClient
	{
		...
		///   
		/// </remarks>
		GetReportScheduleCountResponse GetReportScheduleCount( GetReportScheduleCountRequest request, string marker );
		...
		///   
		/// </remarks>
		GetReportRequestListByNextTokenResponse GetReportRequestListByNextToken( GetReportRequestListByNextTokenRequest request, string marker );
		...
		///   
		/// </remarks>
		UpdateReportAcknowledgementsResponse UpdateReportAcknowledgements( UpdateReportAcknowledgementsRequest request, string marker );
		...
		///   
		/// </remarks>
		SubmitFeedResponse SubmitFeed( SubmitFeedRequest request, string marker );
		...
		///   
		/// </remarks>
		GetReportCountResponse GetReportCount( GetReportCountRequest request, string marker );
		...
		///   
		/// </remarks>
		GetFeedSubmissionListByNextTokenResponse GetFeedSubmissionListByNextToken( GetFeedSubmissionListByNextTokenRequest request, string marker );
		...
		///   
		/// </remarks>
		CancelFeedSubmissionsResponse CancelFeedSubmissions( CancelFeedSubmissionsRequest request, string marker );
		...
		///   
		/// </remarks>
		RequestReportResponse RequestReport( RequestReportRequest request, string marker );
		...
		///   
		/// </remarks>
		GetFeedSubmissionCountResponse GetFeedSubmissionCount( GetFeedSubmissionCountRequest request, string marker );
		...
		///   
		/// </remarks>
		CancelReportRequestsResponse CancelReportRequests( CancelReportRequestsRequest request, string marker );
		...
		///   
		/// </remarks>
		GetReportListResponse GetReportList( GetReportListRequest request, string marker );
		...
		///   
		/// </remarks>
		GetFeedSubmissionResultResponse GetFeedSubmissionResult( GetFeedSubmissionResultRequest request, string marker );
		...
		///   
		/// </remarks>
		GetFeedSubmissionListResponse GetFeedSubmissionList( GetFeedSubmissionListRequest request, string marker );
		...
		///   
		/// </remarks>
		GetReportRequestListResponse GetReportRequestList( GetReportRequestListRequest request, string marker );
		...
		///   
		/// </remarks>
		GetReportScheduleListByNextTokenResponse GetReportScheduleListByNextToken( GetReportScheduleListByNextTokenRequest request, string marker );
		...
		///   
		/// </remarks>
		GetReportListByNextTokenResponse GetReportListByNextToken( GetReportListByNextTokenRequest request, string marker );
		...
		///   
		/// </remarks>
		ManageReportScheduleResponse ManageReportSchedule( ManageReportScheduleRequest request, string marker );
		...
		///   
		/// </remarks>
		GetReportRequestCountResponse GetReportRequestCount( GetReportRequestCountRequest request, string marker );
		...
		///   
		/// </remarks>
		GetReportScheduleListResponse GetReportScheduleList( GetReportScheduleListRequest request, string marker );
	}
}