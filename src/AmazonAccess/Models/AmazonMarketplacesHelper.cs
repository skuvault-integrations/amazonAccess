...
namespace AmazonAccess.Models
{
    ...
    /// </summary>
    public static class AmazonMarketplacesHelper
    {
        ...
        //TODO GUARD-2258 Add tests: return true, return false
        //TODO GUARD-2258 Call from v1
        ...
        internal static AmazonMarketplaceBasicInfo GetMarketplaceByCountryCode( AmazonCountryCodeEnum countryCode )
        {
            AmazonMarketplaceBasicInfo marketplace;
            if ( !AmazonMarketplaces.TryGetValue( countryCode, out marketplace ) )
            {
