...
{
	[ TestFixture ]
	public class InventoryFeedXmlServiceTestsMFN
	{
		[ Test ]
		public void GivenInventoryFeedXmlServiceInstantiatedWithMFN_WhenGetDocumentStringIsCalled_ThenReturnsCorrectItemDetails()
		{
			...
			var feedService = new InventoryFeedXmlServiceMFN( inventoryItems, sellerId );
	...
	[ TestFixture ]
	public class InventoryFeedXmlServiceTestsMFNOff
	{
		[ Test ]
		public void GivenInventoryFeedXmlServiceInstantiatedWithMFNOff_WhenGetDocumentStringIsCalled_ThenReturnsCorrectItemDetails()	
		{ 
			const string sku = "testSku1";
			const int quantity = 123;
			const int fulfillmentLatency = 3;
		...
		[ Test ]
		public void GivenInventoryFeedXmlServiceInstantiatedWithMFNOff_WhenGetDocumentStringIsCalled_ThenDoesntReturnMFN()
		{
			var inventoryItems = new List<AmazonInventoryItem>
			{
				new AmazonInventoryItem
